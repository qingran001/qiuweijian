				...
				<div class="callout callout-warning">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
							<p>使用支付宝购买</p>
							<p>目前价格为:0.5元每GB。</p>
                            <p><input type="text" class="form-control" placeholder="购买量必须为不大于1000的正整数，单位为GB" id="num"></p>
                            <p><a class="btn btn-success btn-sm" onclick="buy(); return false;" id="buybutton">购买</a></p>
                        </div><!-- /.box -->
                    </div>
